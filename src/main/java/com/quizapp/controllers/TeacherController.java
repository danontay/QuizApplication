...
public class TeacherController {
	...
	public String showTeacherDashboard(Model model) {
		...
		sessions.forEach(elem -> System.out.println(elem.getStudent()));

		model.addAttribute("allSessions", sessions);
		model.addAttribute("teacher", teacherService.getTeacherById(CurrentUserController.getTeacher().getId()));
	...
	public String showAllSchedulePage(Model model) {
		...
		List<ScheduleDTO> schedules = scheduleRepository.findAllSchedule(CurrentUserController.getTeacher().getId());
